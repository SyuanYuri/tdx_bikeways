<template>
  <div class="overflow-hidden w-screen h-screen bg-dark_100 grid">
    <div class="flex flex-col justify-center my-auto">
      <div>
        <h3 class="text-left text-light text-3xl ml-10 phone:ml-28 my-4">
          自行車路線總覽
        </h3>
      </div>
      <Map />
            ...
            <div class="flex flex-col tablet:flex-row">
              ...
              >
                <span class="flex pl-4 pr-6">
                  ...
                  <span
                    class="text-dark ml-2 font-bold text-sm whitespace-nowrap"
                  >
                    查詢
                  </span>
                </span>
          ...
          <div class="flex flex-col laptop:mt-4 mt-0 laptop:ml-0 ml-2">
            ...
            <div class="flex tablet:mr-auto">
              ...
              >
                ...
                <option
                  v-for="item in districtList.list"
                  :key="item"
                  :value="item"
                >
                  {{ item }}
          ...
          <ul class="grid grid-cols-1 desktop:grid-cols-2">
            <li v-for="item in stationRoute.list" :key="item">
              ...
              >
                ...
                >
                  <div class="flex my-auto content-center">
                    <!-- <div class="my-auto mr-4 h-full">
                      <img
                        class="h-10"
                        src="@/assets/images/icon-station.svg"
                        alt=""
                      />
                    </div> -->
                    <div class="flex flex-col">
                      ...
                      <div class="flex text-sm text-gray my-auto">
                        {{ `${item.City} | ${item.AuthorityName}` }}
                      </div>
                    </div>
                  </div>
                ...
                <!-- <div class="flex phone:flex-col flex-row my-auto">
                  <button
                    class="
                      bg-blue_100
                      text-white
...
<script>
import { routeCityList } from "@/components/RouteCityList.js";
