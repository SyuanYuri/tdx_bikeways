<template>
  <div class="overflow-hidden">
    <div class="search-box">
      <div
        class="rounded-xl bg-blue_100 text-yellow shadow-2xl"
      ...
      >
        <div class="px-5 pt-8 pb-4">
          ...
          <div class="flex">
            ...
            <button @click="getNearByStation()">
              <img
                class="h-14 ml-2"
                src="@/assets/images/icon_search_btn.png"
                alt=""
              />
            </button>
          </div>
              ...
              <div>
                <div class="flex content-center">
                  ...
                  <div class="flex flex-col">
                    <span class="text-light text-lg text-left w-48">
                    ...
                    總數：${
                      item.AvailableRentBikes + item.AvailableReturnBikes
                    }`
                        }}
                      </span>
                    </div>
                ...
                <div class="w-60 text-left text-xs text-gray mt-2">
        ...
        <div v-show="noData" class="h-16 py-5 border-t-2 border-blue_400">
          尚無符合的資料
        </div>
      </div>
    </div>
